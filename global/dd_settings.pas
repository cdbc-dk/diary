{***************************************************************
* 11.11.2022 /bc once was a simple app settings persistence    *
***************************************************************}
unit dd_settings;
{$mode objfpc}{$H+}
interface
...
type
  ...
  public
    ...
    property MatchAll: boolean read fMatchAll write fMatchAll;
  end;
...
begin
  ...
  fCaseSensitive:= fIni.ReadBool('Engine','CaseSensitive',false); { case sensitivity in search-engine }
  fMatchAll:= fIni.ReadBool('Engine','MatchAll',true); { no of matches returned by search-engine }
  Result:= true;
end;
...
begin
  ...
  fIni.WriteBool('Engine','CaseSensitive',fCaseSensitive); { case sensitivity in search-engine }
  fIni.WriteBool('Engine','MatchAll',fMatchAll); { no of matches returned by search-engine }
  fIni.UpdateFile;
  Result:= true;;
end;
